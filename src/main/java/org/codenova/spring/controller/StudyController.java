...
public class StudyController {
 /*
    ...
    @RequestMapping("/two")
    public String studyOneHandle(Model model) {
 ...
 */
    ...
    /*
        @RequestParam 을 설정하면 필수 파라미터로 처리된다. 만약 안넘어와도 되는 파라미터라면..? 추가 처리가 필요하다.
     */
    @RequestMapping("/four")
    ...
    /*
        ...
        ModeAttribute 로 받을때 할 수 있는 아주 효율적인 기능이 하나 더 있다.
    ...
    public void studySevenHandle(@PathVariable String subject) {
